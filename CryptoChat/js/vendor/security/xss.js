// src https://github.com/leizongmin/js-xss
    ...
    return s;
        ...
        1: [
            function(require, module, exports) {
                ...
                const FilterCSS = require("cssfilter").FilterCSS;
                const getDefaultCSSWhiteList = require("cssfilter").getDefaultWhiteList;
                var _ = require("./util");
                    ...
                    var retHtml = parseTag(html,
                        function(sourcePosition, position, tag, html, isClosing) {
                            ...
                            if (info.isWhite) {
                                ...
                                const attrsHtml = parseAttr(attrs.html,
                                    function(name, value) {
